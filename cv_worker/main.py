...
# ── attention pipeline ────────────────────────────────
from cv_attention.facemesh import FaceMeshDetector
from cv_attention.head_pose import estimate_head_pose
from cv_attention.ear import get_ear
from cv_attention.attention_score import compute_attention_score
from cv_attention.aggregator import ScoreAggregator
from cv_attention.face_id import FaceIdentifier, compute_simple_embedding
import state
...
def open_camera():
    sources = [
        ("http://10.72.177.114:4747/video", "DroidCam"),
        (0, "webcam index 0"),
        (2, "webcam index 2"),
    ]
    while True:
